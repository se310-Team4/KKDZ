...
//       if (i % 2) {
//         cy.get(".tile").eq(i).invoke("text", i);
//       }
//     }
...
//     for (let i = 0; i < TOTAL_CELL; i++) {
//       if (i % 2) {
//         cy.get(".tile").eq(i).invoke("text", 2);
//       } else {
//         cy.get(".tile").eq(i).invoke("text", 4);
//       }
//     }
...
//   it("test win", () => {
//     cy.get(".tile").eq(0).invoke("text", 1024);
//     cy.get(".tile").eq(1).invoke("text", 1024);
